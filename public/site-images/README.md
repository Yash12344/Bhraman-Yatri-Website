...
The exception is **Bhrigu Lake** — `treks/bhrigu-lake.jpg` and the four images
in `treks/gallery/bhrigu-lake/` are real photographs, lifted from the
operator's own page for that trek. They are not in the placeholder generator.
