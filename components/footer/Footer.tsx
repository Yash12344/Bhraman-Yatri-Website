...
export function Footer() {
  return (
    <footer className="bg-forest-800 text-white/80">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:grid-cols-2 sm:px-6 lg:grid-cols-[1.4fr_0.8fr_1fr_1.1fr_1.1fr] lg:px-8">
        <div>
          <Logo variant="light" />
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-4 text-xs text-white/60 sm:px-6 md:flex-row lg:px-8">
          <p>{SITE.copyright}</p>
