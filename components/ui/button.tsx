...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 font-semibold uppercase tracking-wide whitespace-nowrap transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-saffron-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 cursor-pointer",
  {
    variants: {
      variant: {
        primary:
